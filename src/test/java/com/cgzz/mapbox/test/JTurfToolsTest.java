...
public class JTurfToolsTest {
    ...
    /**
     * 测试交集之后产生MultiPolygon的处理
     */
    private static void testInterMultiPolygon() {
        ...
        Polygon interPolygon = JTurfTools.calcCircleAndPolygonIntersection(centerPoint, 5000, polygon);
