...
public final class JTurfMeasurement {
    ...
    public static double distance(Point p1, Point p2, Units units) {
        double dLat = JTurfHelper.degreesToRadians(p2.getLatitude() - p1.getLatitude());
        double dLon = JTurfHelper.degreesToRadians(p2.getLongitude() - p1.getLongitude());
        double lat1 = JTurfHelper.degreesToRadians(p1.getLatitude());
        double lat2 = JTurfHelper.degreesToRadians(p2.getLatitude());
    ...
    private static double ringArea(List<Point> coordinates) {
        ...
        if (coordsLength > 2) {
            for (int i = 0; i < coordsLength; i++) {
                ...
                total += (JTurfHelper.angleToRadians(p3.getLongitude()) - JTurfHelper.angleToRadians(p1.getLongitude())) * Math.sin(JTurfHelper.angleToRadians(p2.getLatitude()));
            }
    ...
    public static double bearing(Point p1, Point p2, boolean finalBearing) {
        ...
        double lon1 = JTurfHelper.degreesToRadians(p1.getLongitude());
        double lon2 = JTurfHelper.degreesToRadians(p2.getLongitude());
        double lat1 = JTurfHelper.degreesToRadians(p1.getLatitude());
        double lat2 = JTurfHelper.degreesToRadians(p2.getLatitude());
    ...
    public static Point destination(Point p, double distance, double bearing, Units units) {
        double longitude1 = JTurfHelper.degreesToRadians(p.getLongitude());
        double latitude1 = JTurfHelper.degreesToRadians(p.getLatitude());
    ...
    private static double calculateRhumbBearing(Point start, Point end) {
        double phi1 = JTurfHelper.degreesToRadians(start.getLatitude());
        double phi2 = JTurfHelper.degreesToRadians(end.getLatitude());
        double deltaLambda = JTurfHelper.degreesToRadians(end.getLongitude() - start.getLongitude());
    ...
    public static Point centroid(Geometry geometry) {
        ...
        JTurfMeta.coordEach(geometry, (g, p, index, multiIndex, geomIndex) -> {
