...
import static com.cgzz.mapbox.jturf.util.polygonclipping.Vector.cosineOfAngle;
import static com.cgzz.mapbox.jturf.util.polygonclipping.Vector.sineOfAngle;
...
public class SweepEvent implements Comparable<SweepEvent> {
    ...
    public void link(SweepEvent other) {
        if (other.point == this.point) {
            throw new JTurfException("Tried to link already linked events");
        }
