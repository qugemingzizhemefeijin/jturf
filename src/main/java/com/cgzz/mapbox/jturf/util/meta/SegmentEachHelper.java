...
import com.cgzz.mapbox.jturf.util.meta.func.SegmentEachFunc;
    ...
    public static void segmentEach(Geometry geometry, SegmentEachFunc func) {
        FlattenEachHelper.flattenEach(geometry, (feature, featureIndex, multiFeatureIndex) -> {
            ...
            if (!CoordEachHelper.coordEach(feature, (currentCoord, coordIndex, featureIndexCoord, multiPartIndexCoord, geometryIndex) -> {
                ...
                if (!func.accept(currentSegment, featureIndex, multiFeatureIndex, geometryIndex, segmentIndex.value)) {
                    return false;
                }
